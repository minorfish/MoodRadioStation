...
- (CGFloat)contentViewHeight
{
    ...
    height += 40 + 55 + SCREEN_WIDTH * 2 + self.tabBarController.tabBar.frame.size.height;
    return height;
}
...
- (void)loadMoodCategoryView
{
    ...
    NSDictionary *attributes = @{NSFontAttributeName: [UIFont systemFontOfSize:15]};
    CGFloat height = [titleLabel.text sizeWithAttributes:attributes].height;
    ...
    [view mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(@(SCREEN_WIDTH + height + 5));
    }];
}
